...
.defines(function(){
	...
	EntityPlayer = ig.Entity.extend({
		...
		animSheet: new ig.AnimationSheet( 'spritesheets/walk.png', 150, 115 ),

		init: function ( x , y, settings ) {
			this.addAnim( 'idle', 0.1, [1, 2, 3, 4, 5, 6, 8, 9, 10, 11, 12, 13, 14] );
	...
	StickSk8rGame = ig.Game.extend({
		...
		init: function() {
			...
			this.player = this.spawnEntity( EntityPlayer, 20, 20, {} );
		},
